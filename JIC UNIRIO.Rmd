...
É uma linguagem que pretende simplificar a codificação de dados.<br>
No caso do R Markdown, ela serve para definir informações (metadados) do documento, inclusive sua estilização.<br>
...
Basta alterar o atributo `output`. Exemplo:
* Para gerar um PDF: 
`output: pdf_document`
